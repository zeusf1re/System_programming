...
section ".data" writeable
	...
	newline db 10
    debug_msg1 db "Debug: InsertZeros returned: ", 0
    debug_msg1_len equ $ - debug_msg1
    b_debug rb 256
section ".programm:" executable
    ...
    InsertZeros:
        ...
        mov eax, [ebp + 8]
        mov ecx, 10 ; ebx - множитель/делитель
        .loop:
            xor edx, edx
            div ecx ; edx - остаток, eax - целое
            cmp eax, 0
            je .end ; edx - res
